...
- [UI Guidelines](../docs/ui-guidelines.md) - Core UI guidelines, color palette, button styles, and accessibility requirements
- [Testing Guidelines](../docs/testing-guidelines.md) - Unit, integration, and E2E testing principles, tools, and conventions
- [Coding Guidelines](../docs/coding-guidelines.md) - Coding style, formatting, import organization, linting, and quality principles
